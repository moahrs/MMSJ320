...
; unsigned char digit;
; divs[0] = 1000000000UL;
       move.l    #1000000000,(A2)
; divs[1] = 100000000UL;
       move.l    #100000000,4(A2)
; divs[2] = 10000000UL;
       move.l    #10000000,8(A2)
; divs[3] = 1000000UL;
       move.l    #1000000,12(A2)
; divs[4] = 100000UL;
       move.l    #100000,16(A2)
; divs[5] = 10000UL;
       move.l    #10000,20(A2)
...
; digit++;
       addq.b    #1,D3
       bra       mprintf_ulong_dec_4
mprintf_ulong_dec_6:
; }
; if (digit || started || i == 9)
       and.l     #255,D3
       bne.s     mprintf_ulong_dec_9
       tst.l     D4
       bne.s     mprintf_ulong_dec_9
       cmp.l     #9,D2
       bne.s     mprintf_ulong_dec_7
mprintf_ulong_dec_9:
; {
; printChar('0' + digit, 1);
       pea       1
...
; printChar('0', 1);
       ...
       addq.w    #8,A7
; return;
       bra       mprintf_ulong_hex_13
mprintf_ulong_hex_1:
; }
; while (v && n < 8)
mprintf_ulong_hex_4:
       tst.l     D4
       beq       mprintf_ulong_hex_6
       cmp.l     #8,D2
       bge.s     mprintf_ulong_hex_7
       moveq     #1,D0
       bra.s     mprintf_ulong_hex_8
mprintf_ulong_hex_7:
       clr.l     D0
mprintf_ulong_hex_8:
       tst.l     D0
...
; tmp[n] = (char)('A' + d - 10);
       ...
       sub.l     #10,D0
       move.b    D0,0(A2,D2.L)
mprintf_ulong_hex_10:
; n++;
       addq.l    #1,D2
; v = v >> 4;
       lsr.l     #4,D4
       bra       mprintf_ulong_hex_4
mprintf_ulong_hex_6:
; }
; while (n > 0)
mprintf_ulong_hex_11:
       cmp.l     #0,D2
       ble.s     mprintf_ulong_hex_13
; {
; n--;
       subq.l    #1,D2
; printChar(tmp[n], 1);
       ...
       jsr       _printChar
       addq.w    #8,A7
       bra       mprintf_ulong_hex_11
mprintf_ulong_hex_13:
       movem.l   (A7)+,D2/D3/D4/A2
       unlk      A6
       rts
; }
...
; if (vStep % 13 == 0)
       ...
       swap      D0
       tst.b     D0
       bne.s     carregaBasic_14
; {
; if (vPosAnim == 3)
       cmp.b     #3,D5
       bne.s     carregaBasic_13
; {
; vPosAnim = 0;
       clr.b     D5
; videoCursorPosColX = vAntX;
...
; if (vByte != ALL_OK)
       tst.b     D2
       beq.s     carregaBasic_22
; return vByte;
       and.l     #255,D2
       move.l    D2,D0
       bra.s     carregaBasic_3
carregaBasic_22:
       bra       carregaBasic_8
carregaBasic_10:
; }
