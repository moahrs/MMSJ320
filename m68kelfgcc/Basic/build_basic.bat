...
echo === Building BASIC (m68k-elf-gcc) ===
...
echo.
echo Uso:
echo   build_basic.bat                ^(padrao: ram^)
echo   build_basic.bat ram            ^(usa 0x00870000^)
echo   build_basic.bat flash          ^(usa 0x00002000^)
echo   build_basic.bat 0x00004000     ^(origem customizada^)
echo   build_basic.bat 4000           ^(origem customizada^)
exit /b 0
...
dir basic.elf basic.bin basic.map basic.lst
