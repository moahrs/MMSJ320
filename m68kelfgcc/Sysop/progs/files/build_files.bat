...
echo === Building FILES (m68k-elf-gcc) ===
...
echo.
echo Uso:
echo   build_files.bat                ^(padrao: ram^)
echo   build_files.bat ram            ^(usa 0x00870000^)
echo   build_files.bat flash          ^(usa 0x00020000^)
echo   build_files.bat 0x00004000     ^(origem customizada^)
echo   build_files.bat 4000           ^(origem customizada^)
exit /b 0
