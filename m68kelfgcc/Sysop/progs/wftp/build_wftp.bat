...
echo === Building WFTP (m68k-elf-gcc) ===
...
:show_help
echo.
echo Uso: build_wftp.bat [ram^|flash^|0xORIGIN]
exit /b 0

:done

echo.
..\..\elftoexe wftp.elf wftp.exe
echo Artefatos gerados:
dir wftp.elf wftp.exe wftp.map wftp.lst
copy /Y wftp.exe D:\PROJETOS\MMSJ320\HD_ATU\MGUI\PROGS\WFTP.EXE
copy /Y wftp.exe F:\MGUI\PROGS\WFTP.EXE
exit /b 0
