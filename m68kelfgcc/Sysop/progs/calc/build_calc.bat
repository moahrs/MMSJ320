...
echo === Building CALC (m68k-elf-gcc) ===
...
:show_help
echo.
echo Uso: build_calc.bat [ram^|flash^|0xORIGIN]
exit /b 0

:done

echo.
..\..\elftoexe calc.elf calc.exe
echo Artefatos gerados:
dir calc.elf calc.exe calc.map calc.lst
copy /Y calc.exe D:\PROJETOS\MMSJ320\HD_ATU\MGUI\PROGS\CALC.EXE
copy /Y calc.exe F:\MGUI\PROGS\CALC.EXE
exit /b 0
