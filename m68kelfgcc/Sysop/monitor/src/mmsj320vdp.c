...
volatile unsigned char *vvdgd = (volatile unsigned char *)0x00400041; // VDP TMS9118 Data Mode
volatile unsigned char *vvdgc = (volatile unsigned char *)0x00400043; // VDP TMS9118 Registers/Address Mode
