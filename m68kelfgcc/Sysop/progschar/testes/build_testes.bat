...
echo === Building testes (m68k-elf-gcc) ===
...
:show_help
echo.
echo Uso: build_testes.bat [MODE]
echo.
echo Modos:
...
echo.
..\..\elftoexe testes.elf testes.exe
echo Artefatos gerados:
dir testes.elf testes.exe testes.map testes.lst
copy /Y testes.exe D:\PROJETOS\MMSJ320\HD_ATU\testes.EXE
copy /Y testes.exe F:\testes.EXE
exit /b 0
