...
echo === Building bbsmmsj (m68k-elf-gcc) ===
...
:show_help
echo.
echo Uso: build_bbsmmsj.bat [MODE]
echo.
echo Modos:
...
echo.
..\..\elftoexe bbsmmsj.elf bbsmmsj.exe
echo Artefatos gerados:
dir bbsmmsj.elf bbsmmsj.exe bbsmmsj.map bbsmmsj.lst
copy /Y bbsmmsj.exe D:\PROJETOS\MMSJ320\HD_ATU\NETWRK\BBSMMSJ.EXE
copy /Y bbsmmsj.exe F:\NETWRK\BBSMMSJ.EXE
exit /b 0
