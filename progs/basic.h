...
unsigned char basVideoCursorShow; // 0 - Esconde o cursor, 1 - Mostra o cursor
unsigned char basVideoSpriteSize; // 0 e 1 - 8x8 unmag e mag, 2 e 3 - 16x16 unmag e mag
...
unsigned char *pStartSimpVar;   // Area Variaveis Simples
unsigned char *pStartArrayVar;   // Area Arrays
unsigned char *pStartString;         // Area Strings
unsigned char *pStartProg;           // Area Programa  deve ser 0x00810000
unsigned char *pStartXBasLoad;       // Area onde será importado o programa em basic texto a ser tokenizado depois
unsigned char *pStartStack;          // Area variaveis sistema e stack pointer
...
{                      // 1a 2a 3a - versoes (-- : desenv/testar, ok : funcionando, .. : nao feito)
  ...
  {"ON",      0x91},   // .. .. ok
  {"INPUT", 	0x92},   // .. ok ok
  {"INKEY$",  0x93},   // .. .. ..  // Antigo GET, verificar
  {"LOCATE",  0x94},   // // Antigo VTAB
  {"", 0x95},   // Antigo HTAB
  {"CLS", 		0x96},   // ok ok ok  // Antigo HOME
  {"CLEAR", 	0x97},   // .. .. ok
  {"DATA", 		0x98},   // .. .. ok
  {"READ", 		0x99},   // .. .. ok
  {"RESTORE", 0x9A},   // .. .. ok
  {"END",     0x9E},   // .. .. ok
  {"STOP",    0x9F},   // .. .. ok
  {"SCREEN",  0xB0},   // .. .. ..  // Antigo TEXT
  {"",      0xB1},   // // Antigo GR
  {"",     0xB2},   // // Antigo HGR
  {"COLOR",   0xB3},   // .. .. ..  // Verificar, novas funcoes Fore, Back, Border
  {"PSET",    0xB4},   // // Antigo PLOT
  {"",    0xB5},   // Antigo HLIN
  {"PRESET",    0xB6},   // Antigo VLIN
  {"",    0xB7},   // NADA
  {"",  0xB8},   // Antigo HCOLOR
  {"",   0xB9},   // Antigo HPLOT
  {"AT",      0xBA},   // .. .. ok
  ...
  {"ASC",     0xC4},   // .. .. ok
  {"PEEK",    0xCD},   // .. .. ok
  {"POKE",    0xCE},   // .. .. ok  // Ver de tirar o parenteses
  {"RND",     0xD1},   // .. .. ok
  {"LEN",     0xDB},   // ok ok ok
  {"VAL",     0xDC},   // ok ok ok
  {"STR$",    0xDD},   // ok ok ok
  {"POINT",   0xE0},   // .. .. ..  // Antigo SCRN, verificar
  {"CHR$",    0xE1},   // ok ok ok
  {"FRE",     0xE2},   // ok ok ok
  {"SQR",     0xE3},   // ok ok ok
  {"SIN",     0xE4},   // ok ok ok
...
enum {
  FILES_RELOC_CLRSCRW_DEF = 0,
  FILES_RELOC_BASTEXT_DEF,
  FILES_RELOC_COUNT
};
...
void (*clearScrWPtr)(unsigned char color);
void (*basTextPtr)(void);
