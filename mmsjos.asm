...
; if (vparam[ix] == 0x20 || vparam[ix] == 0x00)
       ...
       move.b    0(A4,D2.L),D0
       cmp.b     #32,D0
       beq.s     fsOsCommand_81
       and.l     #65535,D2
       move.b    0(A4,D2.L),D0
       bne.s     fsOsCommand_79
fsOsCommand_81:
; {
; vparam[ix] = '\0';
       and.l     #65535,D2
...
fsOsCommand_108:
       cmp.w     #3,D2
       bhi.s     fsOsCommand_110
; {
; if (sqtdtam[ix] == 0)
       and.l     #65535,D2
       lea       -292(A6),A0
       move.b    0(A0,D2.L),D0
       bne.s     fsOsCommand_111
; break;
       bra.s     fsOsCommand_110
fsOsCommand_111:
       addq.w    #1,D2
       bra       fsOsCommand_108
fsOsCommand_110:
...
; if (vqtdtam < 1 || vqtdtam > 12)
       cmp.l     #1,D6
       blt.s     fsOsCommand_120
       cmp.l     #12,D6
       ble.s     fsOsCommand_118
fsOsCommand_120:
; vqtdtam = 1;
       moveq     #1,D6
fsOsCommand_118:
...
; if (vqtdtam < 10)
       cmp.l     #10,D6
       bge.s     fsOsCommand_121
; {
; vbuffer[10] = '0';
       move.b    #48,10(A3)
; vbuffer[11] = sqtdtam[0];
       move.b    -292+0(A6),11(A3)
       bra.s     fsOsCommand_122
fsOsCommand_121:
; }
; else
; {
; vbuffer[10] = sqtdtam[0];
       move.b    -292+0(A6),10(A3)
; vbuffer[11] = sqtdtam[1];
       move.b    -292+1(A6),11(A3)
fsOsCommand_122:
; }
; vbuffer[12] = ' ';
       move.b    #32,12(A3)
...
; vbuffer[13] = sqtdtam[0];
       move.b    -292+0(A6),13(A3)
; vbuffer[14] = sqtdtam[1];
       move.b    -292+1(A6),14(A3)
; vbuffer[15] = sqtdtam[2];
       move.b    -292+2(A6),15(A3)
; vbuffer[16] = sqtdtam[3];
       move.b    -292+3(A6),16(A3)
; vbuffer[17] = ' ';
       move.b    #32,17(A3)
...
; vlinha[11] = 'a';
       move.b    #97,-348+11(A6)
; vlinha[12] = 'm';
       move.b    #109,-348+12(A6)
; vlinha[13] = 'e';
       move.b    #101,-348+13(A6)
; vlinha[14] = ' ';
       move.b    #32,-348+14(A6)
; vlinha[15] = 'i';
       move.b    #105,-348+15(A6)
; vlinha[16] = 's';
       move.b    #115,-348+16(A6)
; vlinha[17] = ' ';
       move.b    #32,-348+17(A6)
; ix = 18;
       moveq     #18,D2
...
fsOsCommand_136:
       ...
       lea       _vdir.L,A0
       move.b    0(A0,D5.L),D0
       beq.s     fsOsCommand_138
       cmp.w     #7,D5
       bhi.s     fsOsCommand_138
; {
...
fsOsCommand_139:
       ...
       add.l     D5,A0
       move.b    8(A0),D0
       beq.s     fsOsCommand_141
       cmp.w     #2,D5
       bhi.s     fsOsCommand_141
; {
...
; if (vparam2[ix] == 0x20 || vparam2[ix] == 0x00)
       ...
       move.b    0(A0,D2.L),D0
       cmp.b     #32,D0
       beq.s     fsOsCommand_153
       and.l     #65535,D2
       lea       -248(A6),A0
       move.b    0(A0,D2.L),D0
       bne.s     fsOsCommand_151
fsOsCommand_153:
; {
; vparam2[ix] = '\0';
       and.l     #65535,D2
...
; if (vparam2[ix] == 0x20 || vparam2[ix] == 0x00)
       ...
       move.b    0(A0,D2.L),D0
       cmp.b     #32,D0
       beq.s     fsOsCommand_161
       and.l     #65535,D2
       lea       -248(A6),A0
       move.b    0(A0,D2.L),D0
       bne.s     fsOsCommand_159
fsOsCommand_161:
; {
; vparam2[ix] = '\0';
       and.l     #65535,D2
...
; memset(basicTaskArg, 0x00, sizeof(basicTaskArg));
       pea       64
       clr.l     -(A7)
       pea       @mmsjos_basicTaskArg.L
       jsr       _memset
       add.w     #12,A7
; if (linhaarg[0] != 0x00)
       move.b    -546+0(A6),D0
       beq.s     fsOsCommand_259
...
fsOsCommand_279:
       ...
       moveq     #1,D0
       bra.s     fsOsCommand_281
fsOsCommand_280:
       clr.l     D0
fsOsCommand_281:
       and.l     #255,D0
       beq.s     fsOsCommand_276
       tst.l     D4
       beq.s     fsOsCommand_276
fsOsCommand_278:
; {
...
; switch (ix)
       ...
       bhs       runFromMGUI_11
       asl.l     #1,D0
       move.w    runFromMGUI_13(PC,D0.L),D0
       jmp       runFromMGUI_13(PC,D0.W)
runFromMGUI_13:
       dc.w      runFromMGUI_14-runFromMGUI_13
       dc.w      runFromMGUI_15-runFromMGUI_13
       dc.w      runFromMGUI_16-runFromMGUI_13
       dc.w      runFromMGUI_17-runFromMGUI_13
       dc.w      runFromMGUI_18-runFromMGUI_13
       dc.w      runFromMGUI_19-runFromMGUI_13
runFromMGUI_14:
; {
; case 0:
...
; printChar(196,1);
       ...
       addq.w    #8,A7
       addq.l    #1,D2
       bra       fsLoadSerialToFile_16
fsLoadSerialToFile_18:
; printChar(191,1);
       pea       1
       pea       191
       move.l    1062,A0
...
; printChar(' ',1);
       ...
       addq.w    #8,A7
       addq.l    #1,D2
       bra       fsLoadSerialToFile_19
fsLoadSerialToFile_21:
; printChar(179,1);
       pea       1
       pea       179
       move.l    1062,A0
...
; printChar(196,1);
       ...
       addq.w    #8,A7
       addq.l    #1,D2
       bra       fsLoadSerialToFile_22
fsLoadSerialToFile_24:
; printChar(217,1);
       pea       1
       pea       217
       move.l    1062,A0
...
; vStep = (vSizeTotalRec >= 20) ? (vSizeTotalRec / 20) : 0;
       cmp.l     #20,D6
       blo.s     fsLoadSerialToFile_25
       move.l    D6,-(A7)
       pea       20
       jsr       ULDIV
       move.l    (A7),D0
       addq.w    #8,A7
       bra.s     fsLoadSerialToFile_26
fsLoadSerialToFile_25:
       clr.b     D0
       ext.w     D0
       ext.l     D0
fsLoadSerialToFile_26:
       move.l    D0,A4
...
; for (ix = 0; ix < vSizeTotalRec; ix += 128)
       clr.l     D2
fsLoadSerialToFile_27:
       cmp.l     D6,D2
       bhs       fsLoadSerialToFile_29
; {
...
; if (vChunkSize > 128)
       cmp.w     #128,D7
       bls.s     fsLoadSerialToFile_30
; vChunkSize = 128;
       move.w    #128,D7
fsLoadSerialToFile_30:
; for (iy = 0; iy < 128; iy++)
       clr.l     D5
fsLoadSerialToFile_32:
       cmp.l     #128,D5
       bge       fsLoadSerialToFile_34
; {
; if (vStep > 0 && ix > 0 && ((ix + iy) % vStep) == 0)
       move.l    A4,D0
       cmp.l     #0,D0
       bls       fsLoadSerialToFile_35
       cmp.l     #0,D2
       bls.s     fsLoadSerialToFile_35
       move.l    D2,D0
       add.l     D5,D0
       move.l    D0,-(A7)
       move.l    A4,-(A7)
...
; printChar(219, 1);  // Cursor cheio
       ...
       jsr       (A0)
       addq.w    #8,A7
fsLoadSerialToFile_35:
; if (iy < vChunkSize)
       and.l     #65535,D7
       cmp.l     D7,D5
       bhs.s     fsLoadSerialToFile_37
; {
; vBuffer[iy] = *xaddress;
       lea       -134(A6),A0
       move.b    (A3),0(A0,D5.L)
; xaddress += 1;
       addq.w    #1,A3
fsLoadSerialToFile_37:
       addq.l    #1,D5
       bra       fsLoadSerialToFile_32
fsLoadSerialToFile_34:
; }
; }
...
; return ERRO_B_WRITE_FILE;
       move.b    #237,D0
       bra       fsLoadSerialToFile_3
fsLoadSerialToFile_39:
       add.l     #128,D2
       bra       fsLoadSerialToFile_27
fsLoadSerialToFile_29:
; }
; }
...
; free(xaddressStart);
       ...
       jsr       (A2)
       addq.w    #4,A7
       bra.s     fsLoadSerialToFile_13
fsLoadSerialToFile_12:
; }
; else
; {
...
; vclusterdirnew = vretpath.ClusterDir;
       move.l    _vretpath+14.L,D5
; //}
; // Coloca o novo diretorio como atual
; vclusterdir = vclusterdirnew;
       move.l    D5,_vclusterdir.L
; vretpath.ClusterDirAtu = vclusterdirnew;
       move.l    D5,_vretpath+18.L
...
fsChangeDir_9:
       and.l     #65535,D4
       cmp.l     #127,D4
       bhs.s     fsChangeDir_11
       move.l    D3,A0
       and.l     #65535,D4
       move.b    0(A0,D4.L),D0
       beq.s     fsChangeDir_11
; vdiratu[ix] = vdirname[ix];
       move.l    D3,A0
       and.l     #65535,D4
       and.l     #65535,D4
       move.b    0(A0,D4.L),0(A2,D4.L)
       addq.w    #1,D4
       bra       fsChangeDir_9
fsChangeDir_11:
; vdiratu[ix] = '\0';
...
; if (vlen > 1 && vdiratu[vlen - 1] == '/')
       cmp.w     #1,D2
       bls.s     fsChangeDir_12
       and.l     #65535,D2
       move.l    D2,D0
       subq.l    #1,D0
       move.b    0(A2,D0.L),D0
       cmp.b     #47,D0
       bne.s     fsChangeDir_12
; vdiratu[vlen - 1] = '\0';
       and.l     #65535,D2
       move.l    D2,D0
       subq.l    #1,D0
...
fsChangeDir_20:
       cmp.w     #1,D2
       bls.s     fsChangeDir_22
       and.l     #65535,D2
       move.l    D2,D0
       subq.l    #1,D0
       move.b    0(A2,D0.L),D0
       cmp.b     #47,D0
       beq.s     fsChangeDir_22
; {
; vlen--;
       subq.w    #1,D2
; vdiratu[vlen] = '\0';
...
; if (vlen > 1 && vdiratu[vlen - 1] == '/')
       cmp.w     #1,D2
       bls.s     fsChangeDir_23
       and.l     #65535,D2
       move.l    D2,D0
       subq.l    #1,D0
       move.b    0(A2,D0.L),D0
       cmp.b     #47,D0
       bne.s     fsChangeDir_23
; vdiratu[vlen - 1] = '\0';
       and.l     #65535,D2
       move.l    D2,D0
       subq.l    #1,D0
...
; if (vlen > 1 && vdiratu[vlen - 1] != '/')
       cmp.w     #1,D2
       bls.s     fsChangeDir_28
       and.l     #65535,D2
       move.l    D2,D0
       subq.l    #1,D0
       move.b    0(A2,D0.L),D0
       cmp.b     #47,D0
       beq.s     fsChangeDir_28
; {
; strcat((char *)vdiratu, "/");
       pea       @mmsjos_27.L
       move.l    A2,-(A7)
...
fsChangeDir_30:
       ...
       and.l     #65535,D4
       move.b    0(A0,D4.L),D0
       beq.s     fsChangeDir_32
       and.l     #65535,D2
       cmp.l     #127,D2
       bhs.s     fsChangeDir_32
; {
; vdiratu[vlen] = vdirname[ix];
       move.l    D3,A0
       and.l     #65535,D4
       and.l     #65535,D2
       move.b    0(A0,D4.L),0(A2,D2.L)
; vlen++;
       addq.w    #1,D2
; ix++;
       addq.w    #1,D4
...
@mmsjos_1:
       dc.b      13,10,0
@mmsjos_2:
       dc.b      77,77,83,74,45,79,83,32,118,49,46,48,97,48,52
       dc.b      0
@mmsjos_3:
...
@mmsjos_31:
       ...
       dc.b      32,114,117,110,32,66,97,115,105,99,46,46,46
       dc.b      13,10,0
@mmsjos_32:
       dc.b      67,76,83,0
@mmsjos_33:
...
@mmsjos_43:
       dc.b      95,95,67,80,95,95,46,84,77,80,0
@mmsjos_44:
       dc.b      82,69,78,0
@mmsjos_45:
...
@mmsjos_57:
       dc.b      83,116,97,114,116,105,110,103,32,66,97,115,105
       dc.b      99,32,119,105,116,104,32,112,97,114,97,109,101
       dc.b      116,101,114,58,32,0
@mmsjos_58:
       dc.b      69,120,101,99,117,116,105,110,103,32,66,97,115
       dc.b      105,99,13,10,0
@mmsjos_59:
       dc.b      69,110,100,101,100,32,66,97,115,105,99,13,10
       dc.b      0
@mmsjos_60:
...
@mmsjos_71:
       dc.b      65,113,117,105,32,52,13,10,0
@mmsjos_72:
       dc.b      65,113,117,105,32,53,13,10,0
@mmsjos_73:
       dc.b      65,113,117,105,32,54,13,10,0
@mmsjos_74:
       dc.b      65,113,117,105,32,55,13,10,0
@mmsjos_75:
       dc.b      78,111,32,109,101,109,111,114,121,32,116,111
       dc.b      32,114,101,99,101,105,118,101,32,102,105,108
       dc.b      101,46,13,10,0
@mmsjos_76:
