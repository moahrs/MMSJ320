...
; if (((vpicret) && (vbytepic != RETURN_OK)) || ((!vpicret) && (vretfat != RETURN_OK)))
       move.b    -157(A6),D0
       and.l     #255,D0
       beq.s     fsOsCommand_277
       move.w    -302(A6),D0
       bne.s     fsOsCommand_276
fsOsCommand_277:
       tst.b     -157(A6)
       bne.s     fsOsCommand_278
       moveq     #1,D0
       bra.s     fsOsCommand_279
fsOsCommand_278:
       clr.l     D0
fsOsCommand_279:
       and.l     #255,D0
