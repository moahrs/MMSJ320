...
; {
@basic_basSpriteResetCache:
; memset(spriteHandleCache, 0x00, sizeof(spriteHandleCache));
       pea       1024
       clr.l     -(A7)
       pea       @basic_spriteHandleCache.L
       jsr       _memset
       add.w     #12,A7
       rts
; }
...
; {
@basic_basSpritePatternLimit:
; if (spriteSizeSelBas)
       tst.b     @basic_spriteSizeSelBas.L
       beq.s     @basic_basSpritePatternLimit_1
; return 63;
       moveq     #63,D0
       bra.s     @basic_basSpritePatternLimit_3
@basic_basSpritePatternLimit_1:
; return 255;
       move.l    #255,D0
@basic_basSpritePatternLimit_3:
       rts
; }
; static unsigned int basSpritePatternBytes(void)
; {
@basic_basSpritePatternBytes:
; if (spriteSizeSelBas)
       tst.b     @basic_spriteSizeSelBas.L
       beq.s     @basic_basSpritePatternBytes_1
; return 32;
       moveq     #32,D0
       bra.s     @basic_basSpritePatternBytes_3
@basic_basSpritePatternBytes_1:
; return 8;
       moveq     #8,D0
@basic_basSpritePatternBytes_3:
       rts
; }
; static unsigned int basSpriteResolveHandle(unsigned char spriteNumber)
; {
@basic_basSpriteResolveHandle:
       link      A6,#-4
; unsigned int handle;
; if (vdpModeBas == VDP_MODE_TEXT)
       move.b    _vdpModeBas.L,D0
       cmp.b     #3,D0
       bne.s     @basic_basSpriteResolveHandle_1
; return 0;
       clr.l     D0
       bra.s     @basic_basSpriteResolveHandle_3
@basic_basSpriteResolveHandle_1:
; handle = spriteHandleCache[spriteNumber];
       move.b    11(A6),D0
       and.l     #255,D0
       lsl.l     #2,D0
       lea       @basic_spriteHandleCache.L,A0
       move.l    0(A0,D0.L),-4(A6)
; return handle;
       move.l    -4(A6),D0
@basic_basSpriteResolveHandle_3:
       unlk      A6
       rts
; }
...
; vMemTotalVdpBuffer = 16384;
       move.l    #16384,_vMemTotalVdpBuffer.L
; vdpEditCursorBackup = 0x00;
       clr.b     @basic_vdpEditCursorBackup.L
; vdpEditCursorVisible = 0;
       clr.b     @basic_vdpEditCursorVisible.L
; vdpEditBlinkCount = 0;
       clr.w     @basic_vdpEditBlinkCount.L
; vdpEditLineLen = 0;
...
; vdpEditLineStartY = 0;
       clr.l     @basic_vdpEditLineStartY.L
; vdpEditLineEndY = 0;
       clr.l     @basic_vdpEditLineEndY.L
; while_sp = 0;
       clr.l     @basic_while_sp.L
; basicVdpBufferEnabled = 0;
       clr.b     @basic_basicVdpBufferEnabled.L
; spriteSizeSelBas = 0;
...
; if (pTipo == 'S' || pTipo == 'I' || pTipo == 'R')
       cmp.b     #83,D3
       beq.s     inputLineBasic_7
       cmp.b     #73,D3
       beq.s     inputLineBasic_7
       cmp.b     #82,D3
       bne       inputLineBasic_5
inputLineBasic_7:
; {
...
; if (!pIns)
       tst.b     -9(A6)
       bne.s     inputLineBasic_49
; {
; // Sem insercao de caracteres
; if (iw < pQtdInput)
       cmp.l     A3,D7
       bhs.s     inputLineBasic_51
; {
...
; else if ((vtec == 0x08 || vtec == 0x7F) && !pEdit)  // Backspace/Delete
       cmp.b     #8,D2
       beq.s     inputLineBasic_76
       cmp.b     #127,D2
       bne       inputLineBasic_74
inputLineBasic_76:
       tst.b     -10(A6)
       bne.s     inputLineBasic_77
       moveq     #1,D0
       bra.s     inputLineBasic_78
inputLineBasic_77:
       clr.l     D0
inputLineBasic_78:
       ext.w     D0
       ext.l     D0
       tst.l     D0
       beq.s     inputLineBasic_74
; {
; // Digitcao Normal
; if (vbufptr > &vbufInput)
       cmp.l     A2,D6
       bls.s     inputLineBasic_81
; {
; vbufptr--;
       subq.l    #1,D6
; *vbufptr = 0x00;
...
; if ((vtec == 0x08 && iPos > 0) || vtec == 0x7F)
       ...
       cmp.l     #0,D4
       bgt.s     inputLineBasic_88
inputLineBasic_89:
       cmp.b     #127,D2
       bne       inputLineBasic_86
inputLineBasic_88:
; {
; if (vtec == 0x08)
       cmp.b     #8,D2
       bne.s     inputLineBasic_90
; {
; iPos--;
       subq.l    #1,D4
; if (videoCursorPosColX == 0)
       move.w    _videoCursorPosColX.L,D0
       bne.s     inputLineBasic_92
; videoCursorPosColX = 255;
       move.w    #255,_videoCursorPosColX.L
       bra.s     inputLineBasic_93
inputLineBasic_92:
; else
; videoCursorPosColX = videoCursorPosColX - 1;
       subq.w    #1,_videoCursorPosColX.L
...
; if (pTipo != '@')
       cmp.b     #64,D3
       beq.s     inputLineBasic_106
; showCursor();
       move.l    1082,A0
       jsr       (A0)
inputLineBasic_106:
       bra       inputLineBasic_99
inputLineBasic_101:
; }
; hideCursor();
       move.l    1078,A0
...
@basic_basBuildListTextLine_1:
       move.b    0(A3,D7.L),D0
       ext.w     D0
       ext.l     D0
       tst.l     D0
       beq.s     @basic_basBuildListTextLine_3
       move.w    D6,D0
       subq.w    #1,D0
       and.l     #65535,D0
       cmp.l     D0,D2
       bhs.s     @basic_basBuildListTextLine_3
; pOutLine[ix++] = sNumLin[iz++];
       ...
       move.l    D2,D1
       addq.l    #1,D2
       move.b    0(A3,D0.L),0(A0,D1.L)
       bra       @basic_basBuildListTextLine_1
@basic_basBuildListTextLine_3:
; if (ix < (pOutMax - 1))
       move.w    D6,D0
       subq.w    #1,D0
       and.l     #65535,D0
       cmp.l     D0,D2
       bhs.s     @basic_basBuildListTextLine_4
; pOutLine[ix++] = 0x20;
       move.l    D3,A0
       move.l    D2,D0
       addq.l    #1,D2
       move.b    #32,0(A0,D0.L)
@basic_basBuildListTextLine_4:
; vFirstByte = 1;
       move.b    #1,-1(A6)
; while (*pTokenLine && ix < (pOutMax - 3))
@basic_basBuildListTextLine_6:
       move.l    D4,A0
       move.b    (A0),D0
       and.l     #255,D0
       beq       @basic_basBuildListTextLine_8
       move.w    D6,D0
       subq.w    #3,D0
       and.l     #65535,D0
       cmp.l     D0,D2
       bhs       @basic_basBuildListTextLine_8
; {
; vToken = *pTokenLine++;
       move.l    D4,A0
       addq.l    #1,D4
...
; if (vToken >= 0x80)
       and.w     #255,D5
       cmp.w     #128,D5
       blo       @basic_basBuildListTextLine_9
; {
; iy = findToken(vToken);
       and.l     #255,D5
       move.l    D5,-(A7)
...
; if (!vFirstByte)
       tst.b     -1(A6)
       bne       @basic_basBuildListTextLine_11
; {
; if (isalphas(*(pTokenLine - 2)) || isdigitus(*(pTokenLine - 2)) || *(pTokenLine - 2) == ')')
       ...
       addq.w    #4,A7
       tst.l     D0
       bne       @basic_basBuildListTextLine_15
       move.l    D4,D1
       subq.l    #2,D1
       move.l    D1,A0
       move.b    (A0),D1
       ...
       addq.w    #4,A7
       tst.l     D0
       bne.s     @basic_basBuildListTextLine_15
       move.l    D4,D0
       subq.l    #2,D0
       move.l    D0,A0
       move.b    (A0),D0
       cmp.b     #41,D0
       bne.s     @basic_basBuildListTextLine_13
@basic_basBuildListTextLine_15:
; pOutLine[ix++] = 0x20;
       move.l    D3,A0
       move.l    D2,D0
       addq.l    #1,D2
       move.b    #32,0(A0,D0.L)
@basic_basBuildListTextLine_13:
       bra.s     @basic_basBuildListTextLine_12
@basic_basBuildListTextLine_11:
; }
; else
; vFirstByte = 0;
       clr.b     -1(A6)
@basic_basBuildListTextLine_12:
; while (keywords[iy].keyword[iz] && ix < (pOutMax - 1))
@basic_basBuildListTextLine_16:
       move.l    A2,D0
       lsl.l     #3,D0
       ...
       ext.l     D0
       tst.l     D0
       beq       @basic_basBuildListTextLine_18
       move.w    D6,D0
       subq.w    #1,D0
       and.l     #65535,D0
       cmp.l     D0,D2
       bhs.s     @basic_basBuildListTextLine_18
; pOutLine[ix++] = keywords[iy].keyword[iz++];
       ...
       bra       @basic_basBuildListTextLine_16
@basic_basBuildListTextLine_18:
; if (*pTokenLine != '=' && (vToken < 0xC0 || vToken > 0xEF) && ix < (pOutMax - 1))
       move.l    D4,A0
       move.b    (A0),D0
       cmp.b     #61,D0
       beq.s     @basic_basBuildListTextLine_19
       and.w     #255,D5
       cmp.w     #192,D5
       blo.s     @basic_basBuildListTextLine_21
       and.w     #255,D5
       cmp.w     #239,D5
       bls.s     @basic_basBuildListTextLine_19
@basic_basBuildListTextLine_21:
       move.w    D6,D0
       subq.w    #1,D0
       and.l     #65535,D0
       cmp.l     D0,D2
       bhs.s     @basic_basBuildListTextLine_19
; pOutLine[ix++] = 0x20;
       move.l    D3,A0
       move.l    D2,D0
       addq.l    #1,D2
       move.b    #32,0(A0,D0.L)
@basic_basBuildListTextLine_19:
       bra       @basic_basBuildListTextLine_22
@basic_basBuildListTextLine_9:
; }
; else
; {
; pOutLine[ix++] = vToken;
...
; if (vToken == 0x22 && *pTokenLine >= 0x80 && ix < (pOutMax - 1))
       cmp.b     #34,D5
       bne.s     @basic_basBuildListTextLine_22
       move.l    D4,A0
       move.b    (A0),D0
       and.w     #255,D0
       cmp.w     #128,D0
       blo.s     @basic_basBuildListTextLine_22
       move.w    D6,D0
       subq.w    #1,D0
       and.l     #65535,D0
       cmp.l     D0,D2
       bhs.s     @basic_basBuildListTextLine_22
; pOutLine[ix++] = 0x20;
       move.l    D3,A0
       move.l    D2,D0
       addq.l    #1,D2
       move.b    #32,0(A0,D0.L)
@basic_basBuildListTextLine_22:
       bra       @basic_basBuildListTextLine_6
@basic_basBuildListTextLine_8:
; }
; }
; pOutLine[ix] = '\0';
       move.l    D3,A0
...
; if (pWrapRows)
       tst.l     20(A6)
       beq.s     @basic_basBuildListTextLine_24
; *pWrapRows = strlen(pOutLine) / 40;
       ...
       move.l    20(A6),A0
       move.w    D0,(A0)
@basic_basBuildListTextLine_24:
; if (ix < (pOutMax - 2))
       move.w    D6,D0
       subq.w    #2,D0
       and.l     #65535,D0
       cmp.l     D0,D2
       bhs.s     @basic_basBuildListTextLine_26
; {
; pOutLine[ix++] = '\r';
       move.l    D3,A0
       move.l    D2,D0
...
; basBuildListTextLine(vStartList, vLinhaList, sizeof(vLinhaList), &iw);
       ...
       pea       -292(A6)
       move.l    D2,-(A7)
       jsr       @basic_basBuildListTextLine
       add.w     #16,A7
...
_parseExpr:
       link      A6,#-84
       movem.l   D2/D3/D4/D5/D6/D7/A2/A3/A4/A5,-(A7)
       lea       @basic_parseValTop.L,A2
       lea       _vErroProc.L,A3
       lea       @basic_parseOpTop.L,A4
       lea       _token.L,A5
...
; }
; nivelParse++;
       addq.b    #1,@basic_nivelParse.L
; nivelAtual = (unsigned char)nivelParse;
       move.b    @basic_nivelParse.L,D2
; valStack = parseValStack[nivelAtual];
       lea       @basic_parseValStack.L,A0
       and.l     #255,D2
       move.l    D2,D0
       muls      #1600,D0
       add.l     D0,A0
...
; opPrecStack = parseOpPrecStack[nivelAtual];
       lea       @basic_parseOpPrecStack.L,A0
       and.l     #255,D2
       move.l    D2,D0
       lsl.l     #5,D0
       add.l     D0,A0
...
; valTypeStack = parseValTypeStack[nivelAtual];
       lea       @basic_parseValTypeStack.L,A0
       and.l     #255,D2
       move.l    D2,D0
       lsl.l     #5,D0
       add.l     D0,A0
...
; tokenVarAtu = parseTokenVarAtu[nivelAtual];
       lea       @basic_parseTokenVarAtu.L,A0
       and.l     #255,D2
       move.l    D2,D0
       lsl.l     #2,D0
       add.l     D0,A0
...
; tokenVarAtuLen = &parseTokenVarAtuLen[nivelAtual];
       lea       @basic_parseTokenVarAtuLen.L,A0
       and.l     #255,D2
       add.l     D2,A0
       move.l    A0,-4(A6)
...
saveBasFile_9:
       ...
       move.b    0(A0,D2.L),D0
       and.l     #255,D0
       beq.s     saveBasFile_11
       and.l     #65535,D2
       cmp.l     #31,D2
       bhs.s     saveBasFile_11
; {
...
_loadBasFile:
       link      A6,#-40
       movem.l   D2/D3/D4/D5/D6/A2/A3/A4/A5,-(A7)
       lea       _pStartProg.L,A2
       move.l    8(A6),D5
       lea       _startBasic.L,A3
...
loadBasFile_9:
       ...
       move.b    0(A0,D2.L),D0
       and.l     #255,D0
       beq.s     loadBasFile_11
       and.l     #65535,D2
       cmp.l     #31,D2
       bhs.s     loadBasFile_11
; {
; fileName[ix] = toupper(pArquivo[ix]);
       move.l    D5,A0
       and.l     #65535,D2
...
; if (*vbufInput == 0x00)
       move.b    _vbufInput.L,D0
       bne.s     loadBasFile_25
; break;
       bra.s     loadBasFile_20
loadBasFile_25:
; processLine();
       jsr       _processLine
loadBasFile_24:
       bra.s     loadBasFile_22
loadBasFile_21:
; }
; }
; else
...
; if (*vErroProc) return 0;
       move.l    (A2),A0
       tst.w     (A0)
       beq.s     @basic_basBaseString_1
       clr.l     D0
       bra       @basic_basBaseString_3
@basic_basBaseString_1:
; if (*tok == EOL || *tok == FINISHED || *token_type != OPENPARENT)
       move.l    _tok.L,A0
       move.b    (A0),D0
       and.w     #255,D0
       cmp.w     #226,D0
       beq.s     @basic_basBaseString_6
       move.l    _tok.L,A0
       move.b    (A0),D0
       and.w     #255,D0
       cmp.w     #224,D0
       ...
       move.b    (A0),D0
       cmp.b     #8,D0
       beq.s     @basic_basBaseString_4
@basic_basBaseString_6:
; {
; *vErroProc = 15;
       move.l    (A2),A0
       move.w    #15,(A0)
...
; if (*vErroProc) return 0;
       move.l    (A2),A0
       tst.w     (A0)
       beq.s     @basic_basBaseString_7
       clr.l     D0
       bra       @basic_basBaseString_3
@basic_basBaseString_7:
; if (*token_type == QUOTE)
       move.l    (A4),A0
       move.b    (A0),D0
       cmp.b     #6,D0
       bne.s     @basic_basBaseString_9
; {
; *vErroProc = 16;
       move.l    (A2),A0
       move.w    #16,(A0)
...
; if (*vErroProc) return 0;
       move.l    (A2),A0
       tst.w     (A0)
       beq.s     @basic_basBaseString_11
       clr.l     D0
       bra       @basic_basBaseString_3
@basic_basBaseString_11:
; if (*value_type != '%')
       move.l    _value_type.L,A0
       move.b    (A0),D0
       cmp.b     #37,D0
       beq.s     @basic_basBaseString_13
; {
; *vErroProc = 16;
       move.l    (A2),A0
       move.w    #16,(A0)
...
; if (*vErroProc) return 0;
       move.l    (A2),A0
       tst.w     (A0)
       beq.s     @basic_basBaseString_15
       clr.l     D0
       bra       @basic_basBaseString_3
@basic_basBaseString_15:
; if (*token_type != CLOSEPARENT)
       move.l    (A4),A0
       move.b    (A0),D0
       cmp.b     #9,D0
       beq.s     @basic_basBaseString_17
; {
; *vErroProc = 15;
       move.l    (A2),A0
       move.w    #15,(A0)
...
; spriteSizeSelBas = vSpriteSize;
       move.b    D2,@basic_spriteSizeSelBas.L
; basSpriteResetCache();
...
_basFill:
       ...
       lea       _vErroProc.L,A2
       lea       _nextToken.L,A3
       lea       @basic_basReadNumericArg.L,A4
       lea       _token.L,A5
; int x1 = 0, y1 = 0;
       clr.l     -20(A6)
       clr.l     -16(A6)
...
; if (spriteNumber < 0 || spriteNumber > (int)spriteLimit)
       move.l    -296(A6),D0
       cmp.l     #0,D0
       blt.s     basSpriteSet_10
       move.l    -296(A6),D0
       cmp.l     -4(A6),D0
       ble.s     basSpriteSet_8
basSpriteSet_10:
; {
; *vErroProc = 5;
       move.l    (A2),A0
...
; if (*tok == EOL || *tok == FINISHED)
       ...
       and.w     #255,D0
       cmp.w     #226,D0
       beq.s     basSpriteSet_19
       move.l    _tok.L,A0
       move.b    (A0),D0
       and.w     #255,D0
       cmp.w     #224,D0
       bne.s     basSpriteSet_17
basSpriteSet_19:
; {
; *vErroProc = 18;
       move.l    (A2),A0
...
; spriteBytes = basSpritePatternBytes();
       jsr       @basic_basSpritePatternBytes
       move.l    D0,D3
; if (*token_type == QUOTE)
       move.l    _token_type.L,A0
       move.b    (A0),D0
       cmp.b     #6,D0
       bne.s     basSpriteSet_20
; {
...
; if (spriteNumber < 0 || spriteNumber > (int)spriteLimit)
       move.l    -24(A6),D0
       cmp.l     #0,D0
       blt.s     basSpritePut_10
       move.l    -24(A6),D0
       cmp.l     -4(A6),D0
       ble.s     basSpritePut_8
basSpritePut_10:
; {
; *vErroProc = 5;
       move.l    (A2),A0
...
; if (plane < 0 || plane > 31)
       move.l    -20(A6),D0
       cmp.l     #0,D0
       blt.s     basSpritePut_21
       move.l    -20(A6),D0
       cmp.l     #31,D0
       ble.s     basSpritePut_19
basSpritePut_21:
; {
; *vErroProc = 5;
       move.l    (A2),A0
...
; if (xValue < 0 || xValue > 255 || yValue < 0 || yValue > 191)
       move.l    -16(A6),D0
       cmp.l     #0,D0
       blt.s     basSpritePut_48
       move.l    -16(A6),D0
       cmp.l     #255,D0
       bgt.s     basSpritePut_48
       move.l    -12(A6),D0
       cmp.l     #0,D0
       blt.s     basSpritePut_48
       move.l    -12(A6),D0
       cmp.l     #191,D0
       ble.s     basSpritePut_46
basSpritePut_48:
; {
; *vErroProc = 25;
       move.l    (A2),A0
...
; if (colorValue < 0 || colorValue > 15)
       move.l    -8(A6),D0
       cmp.l     #0,D0
       blt.s     basSpritePut_51
       move.l    -8(A6),D0
       cmp.l     #15,D0
       ble.s     basSpritePut_49
basSpritePut_51:
; {
; *vErroProc = 5;
       move.l    (A2),A0
...
; if (spriteNumber < 0 || spriteNumber > (int)spriteLimit)
       move.l    -12(A6),D0
       cmp.l     #0,D0
       blt.s     basSpriteColor_10
       move.l    -12(A6),D0
       cmp.l     -4(A6),D0
       ble.s     basSpriteColor_8
basSpriteColor_10:
; {
; *vErroProc = 5;
       move.l    (A2),A0
...
; if (colorValue < 0 || colorValue > 15)
       move.l    -8(A6),D0
       cmp.l     #0,D0
       blt.s     basSpriteColor_21
       move.l    -8(A6),D0
       cmp.l     #15,D0
       ble.s     basSpriteColor_19
basSpriteColor_21:
; {
; *vErroProc = 5;
       move.l    (A2),A0
...
; if (spriteNumber < 0 || spriteNumber > (int)spriteLimit)
       move.l    -16(A6),D0
       cmp.l     #0,D0
       blt.s     basSpritePos_10
       move.l    -16(A6),D0
       cmp.l     -4(A6),D0
       ble.s     basSpritePos_8
basSpritePos_10:
; {
; *vErroProc = 5;
       move.l    (A2),A0
...
; if (xValue < 0 || xValue > 255 || yValue < 0 || yValue > 191)
       move.l    -12(A6),D0
       cmp.l     #0,D0
       blt.s     basSpritePos_29
       move.l    -12(A6),D0
       cmp.l     #255,D0
       bgt.s     basSpritePos_29
       move.l    -8(A6),D0
       cmp.l     #0,D0
       blt.s     basSpritePos_29
       move.l    -8(A6),D0
       cmp.l     #191,D0
       ble.s     basSpritePos_27
basSpritePos_29:
; {
; *vErroProc = 25;
       move.l    (A2),A0
...
; if (x < 0)
       cmp.l     #0,D2
       bge.s     @basic_basDrawClampX_1
; return 0;
       clr.b     D0
       bra.s     @basic_basDrawClampX_3
@basic_basDrawClampX_1:
; if (x > 255)
       cmp.l     #255,D2
       ble.s     @basic_basDrawClampX_4
; return 255;
       move.b    #255,D0
       bra.s     @basic_basDrawClampX_3
@basic_basDrawClampX_4:
; return (unsigned char)x;
       move.b    D2,D0
@basic_basDrawClampX_3:
       move.l    (A7)+,D2
       unlk      A6
       rts
; }
...
; if (y < 0)
       cmp.l     #0,D2
       bge.s     @basic_basDrawClampY_1
; return 0;
       clr.b     D0
       bra.s     @basic_basDrawClampY_3
@basic_basDrawClampY_1:
; if (y > 191)
       cmp.l     #191,D2
       ble.s     @basic_basDrawClampY_4
; return 191;
       move.b    #191,D0
       bra.s     @basic_basDrawClampY_3
@basic_basDrawClampY_4:
; return (unsigned char)y;
       move.b    D2,D0
@basic_basDrawClampY_3:
       move.l    (A7)+,D2
       unlk      A6
       rts
; }
...
; if (x0 == x1 && y0 == y1)
       move.b    11(A6),D0
       cmp.b     19(A6),D0
       bne       @basic_basDrawLineSegment_1
       move.b    15(A6),D0
       cmp.b     23(A6),D0
       bne.s     @basic_basDrawLineSegment_1
; {
; basVideoPlotHires(x0, y0, color, 0);
       ...
       add.w     #16,A7
; return;
       bra       @basic_basDrawLineSegment_21
@basic_basDrawLineSegment_1:
; }
; x = x0;
       move.b    11(A6),D0
       and.l     #255,D0
...
; if (dx < 0)
       cmp.l     #0,D3
       bge.s     @basic_basDrawLineSegment_4
; dx = -dx;
       move.l    D3,D0
       neg.l     D0
       move.l    D0,D3
@basic_basDrawLineSegment_4:
; if (dy < 0)
       cmp.l     #0,D2
       bge.s     @basic_basDrawLineSegment_6
; dy = -dy;
       move.l    D2,D0
       neg.l     D0
       move.l    D0,D2
@basic_basDrawLineSegment_6:
; addx = (x0 > x1) ? -1 : 1;
       move.b    11(A6),D0
       cmp.b     19(A6),D0
       bls.s     @basic_basDrawLineSegment_8
       moveq     #-1,D0
       bra.s     @basic_basDrawLineSegment_9
@basic_basDrawLineSegment_8:
       moveq     #1,D0
@basic_basDrawLineSegment_9:
       move.l    D0,A3
; addy = (y0 > y1) ? -1 : 1;
       move.b    15(A6),D0
       cmp.b     23(A6),D0
       bls.s     @basic_basDrawLineSegment_10
       moveq     #-1,D0
       bra.s     @basic_basDrawLineSegment_11
@basic_basDrawLineSegment_10:
       moveq     #1,D0
@basic_basDrawLineSegment_11:
       move.l    D0,A2
; if (dx >= dy)
       cmp.l     D2,D3
       blt       @basic_basDrawLineSegment_12
; {
; p = (2 * dy) - dx;
       move.l    D2,-(A7)
       pea       2
...
; for (ix = 1; ix <= (dx + 1); ix++)
       moveq     #1,D5
@basic_basDrawLineSegment_14:
       move.l    D3,D0
       addq.l    #1,D0
       cmp.l     D0,D5
       bgt       @basic_basDrawLineSegment_16
; {
...
; if (p < 0)
       cmp.l     #0,D4
       bge.s     @basic_basDrawLineSegment_17
; {
; p = p + (2 * dy);
       move.l    D2,-(A7)
       pea       2
...
; x = x + addx;
       add.l     A3,D7
       bra       @basic_basDrawLineSegment_18
@basic_basDrawLineSegment_17:
; }
; else
; {
; p = p + (2 * dy) - (2 * dx);
...
; y = y + addy;
       add.l     A2,D6
@basic_basDrawLineSegment_18:
       addq.l    #1,D5
       bra       @basic_basDrawLineSegment_14
@basic_basDrawLineSegment_16:
       bra       @basic_basDrawLineSegment_21
@basic_basDrawLineSegment_12:
; }
; }
; }
; else
...
; for (ix = 1; ix <= (dy + 1); ix++)
       moveq     #1,D5
@basic_basDrawLineSegment_19:
       move.l    D2,D0
       addq.l    #1,D0
       cmp.l     D0,D5
       bgt       @basic_basDrawLineSegment_21
; {
; basVideoPlotHires((unsigned char)x, (unsigned char)y, color, 0);
       clr.l     -(A7)
       move.b    27(A6),D1
...
; if (p < 0)
       cmp.l     #0,D4
       bge.s     @basic_basDrawLineSegment_22
; {
; p = p + (2 * dx);
       move.l    D3,-(A7)
       pea       2
...
; y = y + addy;
       add.l     A2,D6
       bra       @basic_basDrawLineSegment_23
@basic_basDrawLineSegment_22:
; }
; else
; {
; p = p + (2 * dx) - (2 * dy);
...
; y = y + addy;
       add.l     A2,D6
@basic_basDrawLineSegment_23:
       addq.l    #1,D5
       bra       @basic_basDrawLineSegment_19
@basic_basDrawLineSegment_21:
       movem.l   (A7)+,D2/D3/D4/D5/D6/D7/A2/A3/A4
       unlk      A6
       rts
; }
...
; found = 0;
       clr.l     D5
; while (pCmd[pos] == ' ')
@basic_basDrawReadNumber_1:
       move.l    D3,A0
       move.b    0(A0,D2.L),D0
       cmp.b     #32,D0
       bne.s     @basic_basDrawReadNumber_3
; pos++;
       addq.l    #1,D2
       bra       @basic_basDrawReadNumber_1
@basic_basDrawReadNumber_3:
; while (pCmd[pos] >= '0' && pCmd[pos] <= '9')
@basic_basDrawReadNumber_4:
       move.l    D3,A0
       move.b    0(A0,D2.L),D0
       cmp.b     #48,D0
       blo       @basic_basDrawReadNumber_6
       move.l    D3,A0
       move.b    0(A0,D2.L),D0
       cmp.b     #57,D0
       bhi.s     @basic_basDrawReadNumber_6
; {
; found = 1;
       moveq     #1,D5
...
; pos++;
       addq.l    #1,D2
       bra       @basic_basDrawReadNumber_4
@basic_basDrawReadNumber_6:
; }
; if (!found)
       tst.l     D5
       bne.s     @basic_basDrawReadNumber_7
; return 0;
       clr.l     D0
       bra.s     @basic_basDrawReadNumber_9
@basic_basDrawReadNumber_7:
; *pPos = pos;
       move.l    12(A6),A0
       move.l    D2,(A0)
; *pValue = val;
...
; *lastHgrX = basDrawClampX(nx);
       move.l    -12(A6),-(A7)
       jsr       @basic_basDrawClampX
       addq.w    #4,A7
       move.l    (A5),A0
       move.b    D0,(A0)
; *lastHgrY = basDrawClampY(ny);
       move.l    -8(A6),-(A7)
       jsr       @basic_basDrawClampY
       addq.w    #4,A7
       move.l    (A4),A0
       move.b    D0,(A0)
; if (!moveOnly)
...
@basic_18:
       ...
       dc.b      32,101,120,112,101,99,116,101,100,0
@basic_19:
       dc.b      63,67,111,109,109,97,32,69,120,112,101,99,116
       dc.b      101,100,0
@basic_20:
...
@basic_29:
       dc.b      63,87,69,78,68,32,119,105,116,104,111,117,116
       dc.b      32,87,72,73,76,69,0
@basic_30:
       dc.b      63,84,111,111,32,109,97,110,121,32,110,101,115
       dc.b      116,101,100,32,87,72,73,76,69,0
@basic_31:
       dc.b      76,69,84,0
@basic_32:
...
@basic_keywords:
       ...
       dc.l      @basic_76,190,@basic_77,196,@basic_78,197
       dc.l      @basic_79,198,@basic_80,199,@basic_81,205
       dc.l      @basic_82,206,@basic_83,209,@basic_84,219
       dc.l      @basic_85,220,@basic_86,221,@basic_87,222
       dc.l      @basic_88,224,@basic_89,225,@basic_90,226
       dc.l      @basic_91,227,@basic_92,228,@basic_93,229
       dc.l      @basic_94,230,@basic_95,231,@basic_96,232
       dc.l      @basic_97,233,@basic_98,234,@basic_99,235
       dc.l      @basic_100,236,@basic_101,237,@basic_102
       dc.l      238,@basic_103,239,@basic_104,243,@basic_105
       dc.l      244,@basic_106,245,@basic_107,246,@basic_108
       dc.l      247,@basic_109,248
...
@basic_listError:
       ...
       dc.l      @basic_26,@basic_27,@basic_28,@basic_29,@basic_30
       xdef      _vvdgBASd
_vvdgBASd:
       dc.l      4194369
       xdef      _vvdgBASc
...
@basic_parseOpStack:
       ds.b      128
@basic_parseOpPrecStack:
       ds.b      128
@basic_parseValTypeStack:
       ds.b      128
@basic_parseTemp:
       ds.b      200
@basic_parseTokenVarAtu:
       ds.b      16
@basic_parseTokenVarAtuLen:
       ds.b      4
@basic_parseOpTop:
       ds.b      16
@basic_parseValTop:
