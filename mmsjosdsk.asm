; D:\PROJETOS\MMSJ320\MMSJOSDSK.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J.Fondse
; /********************************************************************************
...
_fsVer:
; printText("\r\n\0");
       pea       @mmsjosdskfsVer_1.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
; printText("MMSJ-OS v"versionMMSJOS);
       pea       @mmsjosdskfsVer_2.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
; printText("\r\n\0");
...
; printText("Error: ");
       pea       @mmsjosdskprintDiskError_4.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
; switch( pError )
...
; case ERRO_B_FILE_NOT_FOUND    : printText("File not found"); break;
       pea       @mmsjosdskprintDiskError_5.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
...
; case ERRO_B_READ_DISK         : printText("Reading disk"); break;
       pea       @mmsjosdskprintDiskError_6.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_WRITE_DISK        : printText("Writing disk"); break;
       pea       @mmsjosdskprintDiskError_7.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_OPEN_DISK         : printText("Opening disk"); break;
       pea       @mmsjosdskprintDiskError_8.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_INVALID_NAME      : printText("Invalid Folder or File Name"); break;
       pea       @mmsjosdskprintDiskError_9.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_DIR_NOT_FOUND     : printText("Directory not found"); break;
       pea       @mmsjosdskprintDiskError_10.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_CREATE_FILE       : printText("Creating file"); break;
       pea       @mmsjosdskprintDiskError_11.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_APAGAR_ARQUIVO    : printText("Deleting file"); break;
       pea       @mmsjosdskprintDiskError_12.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_FILE_FOUND        : printText("File already exist"); break;
       pea       @mmsjosdskprintDiskError_13.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_UPDATE_DIR        : printText("Updating directory"); break;
       pea       @mmsjosdskprintDiskError_14.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_OFFSET_READ       : printText("Offset read"); break;
       pea       @mmsjosdskprintDiskError_15.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_DISK_FULL         : printText("Disk full"); break;
       pea       @mmsjosdskprintDiskError_16.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_READ_FILE         : printText("Reading file"); break;
       pea       @mmsjosdskprintDiskError_17.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_WRITE_FILE        : printText("Writing file"); break;
       pea       @mmsjosdskprintDiskError_18.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_DIR_FOUND         : printText("Directory already exist"); break;
       pea       @mmsjosdskprintDiskError_19.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_CREATE_DIR        : printText("Creating directory"); break;
       pea       @mmsjosdskprintDiskError_20.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       bra       printDiskError_2
...
; case ERRO_B_NOT_FOUND         : printText("Not found"); break;
       pea       @mmsjosdskprintDiskError_21.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
...
; printText(" - Unknown Code");
       pea       @mmsjosdskprintDiskError_22.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
; break;
...
; }
; printText("!\r\n\0");
       pea       @mmsjosdskprintDiskError_23.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
       unlk      A6
...
; printText("Error, file name must be provided!!\r\n\0");
       pea       @mmsjosdskfsLoadSerialToFile_24.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
...
; printText("Opening File...\r\n\0");
       pea       @mmsjosdskfsLoadSerialToFile_25.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
...
; printText("Writing File...\r\n\0");
       pea       @mmsjosdskfsLoadSerialToFile_26.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
; printChar(218,1);
...
; printChar(191,1);
       ...
       addq.w    #8,A7
; printText("\r\n\0");
       pea       @mmsjosdskfsLoadSerialToFile_1.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
; printChar(179,1);
...
; // Fecha Arquivo
; printText("\r\nClosing File...\r\n\0");
       pea       @mmsjosdskfsLoadSerialToFile_27.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
...
; printText("Serial Load Error...");
       pea       @mmsjosdskfsLoadSerialToFile_28.L
       move.l    1058,A0
       jsr       (A0)
       addq.w    #4,A7
; return ERRO_B_WRITE_FILE;
...
; strcpy(valid_chars,"ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!#$&'()@^_`{}~");
       pea       @mmsjosdskisValidFilename_31.L
       pea       -74(A6)
       jsr       _strcpy
       addq.w    #8,A7
; len = strlen(filename);
