...
6005 X1% = INT(SL% * RX(A,0) + W%) : Y1% = INT(SL% * RX(A,1) + H%)
6010 X2% = INT(SL% * RX(B,0) + W%) : Y2% = INT(SL% * RX(B,1) + H%)
6015 OL(A,0) = RX(A,0) : OL(A,1) = RX(A,1)
6016 OL(B,0) = RX(B,0) : OL(B,1) = RX(B,1)
6020 HPLOT X1%,Y1% TO X2%,Y2%
6030 RETURN
6100 X1% = INT(SL% * OL(A,0) + W%) : Y1% = INT(SL% * OL(A,1) + H%)
6110 X2% = INT(SL% * OL(B,0) + W%) : Y2% = INT(SL% * OL(B,1) + H%)
6120 HPLOT X1%,Y1% TO X2%,Y2%
6130 RETURN
